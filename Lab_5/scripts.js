...
const countryListAllIsoData = [
	...
	{"code": "CW", "code3": "CUW", "name": "CuraÁao", "number": "531"},
	{"code": "CY", "code3": "CYP", "name": "Cyprus", "number": "196"},
	{"code": "CZ", "code3": "CZE", "name": "Czechia", "number": "203"},
	{"code": "CI", "code3": "CIV", "name": "CÙte d'Ivoire", "number": "384"},
	...
	{"code": "RE", "code3": "REU", "name": "RÈunion", "number": "638"},
	{"code": "BL", "code3": "BLM", "name": "Saint BarthÈlemy", "number": "652"},
...
function select25RandomCountries(){
	var randomCountries = []
	for(let i=0; i<25; i++){
		randomCountries.push(countryList[Math.floor(countryList.length*Math.random())]);
	}
	console.log(randomCountries)
}

function select25UniqueRandomCountries(){
	uniqueNumbers = []
	for(let i=0; i<25; i++){
		var num = null;
		do{
			num = Math.floor(countryList.length*Math.random())
		}while(uniqueNumbers.includes(num))
		uniqueNumbers.push(num)
	}
	
	var orderedList = document.querySelector(".countries");
	while(orderedList.hasChildNodes()){
		orderedList.removeChild(orderedList.firstChild);
	}
	uniqueNumbers.forEach(injectCountries);

	var unselectedCountries = []
	for(let i=0; i<countryList.length; i++){
		if(!uniqueNumbers.includes(i)){
			unselectedCountries.push(countryList[i]);
		}
	}
	
	console.log("Unselected countries :" + unselectedCountries);
}

function injectCountries(index){
	var country = document.createElement("li");
	var span1 = document.createElement("span");
	span1.classList.add("normal-weight");
	var node1 = document.createTextNode(countryList[index] + " ");
	span1.appendChild(node1);
	country.appendChild(span1);
	var span2 = document.createElement("span");
	span2.classList.add("bold-weight");
	var node2 = document.createTextNode(getKeyByValue(countryListAlpha2, countryList[index]));
	span2.appendChild(node2);
	country.appendChild(span2);
	var orderedList = document.querySelector(".countries");
	orderedList.appendChild(country)
}
